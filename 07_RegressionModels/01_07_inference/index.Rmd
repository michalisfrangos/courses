...
## Proof for SE (Michalis Frangos added this)
Starting from $y_0= \beta_0 +\beta_1 x_0 +\epsilon,\quad \epsilon\sim\mathcal{N}(0,\sigma^2)$

 $var(y_0) = var(\beta_0 +\beta_1 x_0 +\epsilon)$
 
 $\quad = var(\beta_0 +\beta_1 x_0) +\sigma^2$
 
 $\quad = var(\beta_0+\beta_1 \bar{X} +\beta_1 (x_0-\bar{X})) +\sigma^2$
 
 $\quad = var(\bar{Y}-\beta_1\bar{X}+\beta_1 \bar{X} +\beta_1 (x_0-\bar{X})) +\sigma^2$
 
 $\quad = var(\bar{Y} +\beta_1 (x_0-\bar{X})) +\sigma^2$
 
 $\quad = \sigma^2/n + var(\beta_1) (x_0-\bar{X})^2 +\sigma^2$
 
 $\quad = \sigma^2(1+ 1/n + var(\beta_1) (x_0-\bar{X})^2)$
 
 $\quad = \sigma^2(1+ 1/n + \frac{ (x_0-\bar{X})^2}{\sum_{i=1}^{n}(x_i-\bar{X})})$

For the line SE at x_0 repeat by considering $y_0= \beta_0 +\beta_1 x_0$
